...
import top.cyixlq.cy.R2;
import top.cyixlq.cy.delegates.CyDelegate;

public abstract class BaseBottomDelegate extends CyDelegate implements View.OnClickListener{
    ...
    private int mClickedColor = Color.YELLOW;
